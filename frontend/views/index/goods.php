    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://www.itshop.com<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="http://www.itshop.com<?=$goods->logo?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                中图分配到 img 的src上。 下面的smallpic 则表示小图区域，格式固定，在 a 标签的 rel属性中，
                分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.itshop.com<?=$goods->logo?>',largeimage: 'http://www.itshop.com<?=$goods->logo?>'}"><img src="http://www.itshop.com<?=$goods->logo?>"></a>
                            </li>
                            <li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['index/add_cart'])?>" method="get" class="choose">
                    <input type="hidden" name="goods_id" value="<?=$goods->id?>" class="goods_id"/>
                    <ul>
             ...
             <!--   <script type="text/javascript">
                    $('.add_btn').click(function () {
                        var url = "/*=\yii\helpers\Url::to(['index/cart'])*/?>";
                        $.post(url,$('.choose').serialize(),function (data) {
