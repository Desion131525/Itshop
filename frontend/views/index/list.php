    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['index/goods','id'=>$row->id])?>"><img src="http://www.itshop.com<?=$row->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['index/goods','id'=>$row->id])?>"><?=$row->name?></a></dt>
